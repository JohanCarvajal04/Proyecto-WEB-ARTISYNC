...
import uteq.edu.ec.artisync.dto.security.request.AdminUpdateUserRequest;
import uteq.edu.ec.artisync.dto.security.request.AssignRolesRequest;
import uteq.edu.ec.artisync.dto.security.request.ChangeAccountStatusRequest;
import uteq.edu.ec.artisync.dto.security.request.CreateUserRequest;
...
class AdminUserServiceImplTest {
    ...
    @Mock
    private uteq.edu.ec.artisync.service.shared.report.impl.ReportChartGenerator generadorGraficaReporte;
    ...
    void exportar_conPaginacion_permiteExportarPorLotes() {
        ...
        GeneratedDocument resultado = adminUserService.export(
                new UserFilter(), ReportFormat.PDF, uteq.edu.ec.artisync.service.shared.report.ReportChartType.NINGUNA, 0, 5000, "admin@artisync.dev");
    ...
    void exportar_ConGraficas_GeneraModeloConGraficas() {
        ...
        uteq.edu.ec.artisync.service.shared.report.GeneratedDocument esperado =
                new uteq.edu.ec.artisync.service.shared.report.GeneratedDocument(new byte[]{1}, "application/pdf", "usuarios.pdf");
        when(servicioExportacion.export(any(), any())).thenReturn(esperado);

        uteq.edu.ec.artisync.dto.request.security.UserFilter filtro = new uteq.edu.ec.artisync.dto.request.security.UserFilter();
        uteq.edu.ec.artisync.service.shared.report.GeneratedDocument resultado =
                adminUserService.export(filtro, uteq.edu.ec.artisync.service.shared.report.ReportFormat.PDF,
                        uteq.edu.ec.artisync.service.shared.report.ReportChartType.AMBAS, "admin@artisync.com");

        assertNotNull(resultado);
        verify(generadorGraficaReporte).generateRoleChart(any());
        verify(generadorGraficaReporte).generateCountryChart(any());
        verify(servicioExportacion).export(any(), org.mockito.ArgumentMatchers.eq(uteq.edu.ec.artisync.service.shared.report.ReportFormat.PDF));
    }
}

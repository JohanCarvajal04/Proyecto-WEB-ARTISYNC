...
/**
 * Las rutas de items cuelgan del mismo prefijo que PortfolioController, que
...
class PortfolioItemControllerRoutesTest {

    @Mock private IPortfolioItemService itemServicio;
    @Mock private IPortfolioService portafolioServicio;
    ...
    void setUp() {
        mockMvc = MockMvcBuilders
                .standaloneSetup(
                        new PortfolioItemController(itemServicio),
                        new PortfolioController(portafolioServicio))

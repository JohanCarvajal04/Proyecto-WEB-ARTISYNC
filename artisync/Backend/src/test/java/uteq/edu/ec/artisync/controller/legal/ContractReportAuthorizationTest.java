...
@ContextConfiguration(classes = ContractReportAuthorizationTest.ContextoDePrueba.class)
class ContractReportAuthorizationTest {
    ...
    static class ContextoDePrueba {
        ...
        @Bean
        ContractReportController reporteContratoControlador(IContractReportService servicio) {
            return new ContractReportController(servicio);
        }
    }

    @Autowired
    private ContractReportController controlador;

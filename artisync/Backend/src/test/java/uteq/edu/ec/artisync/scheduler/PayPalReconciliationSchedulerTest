...
class PayPalReconciliationSchedulerTest {

    @Mock private EscrowPaymentRepository pagoGarantiaRepository;
    @Mock private PayPalReconciliationExecutorService reconciliacionPayPalEjecutorServicio;

    @InjectMocks
    private PayPalReconciliationScheduler scheduler;

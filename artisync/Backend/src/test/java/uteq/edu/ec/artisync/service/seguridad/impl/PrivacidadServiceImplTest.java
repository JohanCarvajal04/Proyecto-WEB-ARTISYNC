...
class PrivacidadServiceImplTest {
    ...
    @InjectMocks
    private PrivacidadServiceImpl privacidadService;
    ...
    void solicitarSupresionPropia_anonimizaDatosDelUsuario_sinImpedimentos() {
        ...
        assertEquals("Usuario eliminado", usuario.getNombres());
    ...
    void anonimizarUsuarioAdmin_rechaza_siYaFueAnonimizado() {
        ...
        assertThrows(ExcepcionReglaNegocio.class, () -> privacidadService.anonimizarUsuarioAdmin(1L, 99L));
        verify(usuarioRepository, never()).save(any());
    }

    @Test
    void anonimizarUsuarioAdmin_rechaza_siAdminSeApuntaASiMismo() {
        assertThrows(ExcepcionReglaNegocio.class, () -> privacidadService.anonimizarUsuarioAdmin(1L, 1L));

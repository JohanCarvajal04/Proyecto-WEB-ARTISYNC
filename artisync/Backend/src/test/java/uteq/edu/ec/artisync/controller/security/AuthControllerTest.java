package uteq.edu.ec.artisync.controller.security;
...
import uteq.edu.ec.artisync.dto.security.request.LoginRequest;
import uteq.edu.ec.artisync.dto.security.request.RefreshTokenRequest;
import uteq.edu.ec.artisync.dto.response.comun.MessageResponse;
import uteq.edu.ec.artisync.dto.security.response.TokenResponse;
import uteq.edu.ec.artisync.service.security.AuthService;
...
class AuthControllerTest {
    ...
    void register_devuelveCreated() {
        uteq.edu.ec.artisync.dto.security.request.RegisterRequest requestReg = new uteq.edu.ec.artisync.dto.security.request.RegisterRequest();
        uteq.edu.ec.artisync.dto.security.response.UserResponse resp = new uteq.edu.ec.artisync.dto.security.response.UserResponse();
        when(authService.register(requestReg)).thenReturn(resp);

        ResponseEntity<uteq.edu.ec.artisync.dto.security.response.UserResponse> result = authController.register(requestReg);
    ...
    void verify2Fa_sinTicket_devuelveUnauthorized() {
        ResponseEntity<TokenResponse> res = authController.verify2Fa(null, new uteq.edu.ec.artisync.dto.security.request.TwoFactorRequest(), response);
        assertEquals(HttpStatus.UNAUTHORIZED, res.getStatusCode());
    }

    @Test
    void verify2Fa_conTicket_devuelveOk() {
        uteq.edu.ec.artisync.dto.security.request.TwoFactorRequest request2fa = new uteq.edu.ec.artisync.dto.security.request.TwoFactorRequest();
    ...
    void forgotPassword_devuelveOk() {
        uteq.edu.ec.artisync.dto.security.request.ForgotPasswordRequest req = new uteq.edu.ec.artisync.dto.security.request.ForgotPasswordRequest();
    ...
    void resetPassword_devuelveOk() {
        uteq.edu.ec.artisync.dto.security.request.ResetPasswordRequest req = new uteq.edu.ec.artisync.dto.security.request.ResetPasswordRequest();
        MessageResponse resp = new MessageResponse("Ok");
    ...
    void verify2Fa_ticketBlanco_devuelveUnauthorized() {
        ResponseEntity<TokenResponse> res = authController.verify2Fa("   ", new uteq.edu.ec.artisync.dto.security.request.TwoFactorRequest(), response);
        assertEquals(HttpStatus.UNAUTHORIZED, res.getStatusCode());
    }

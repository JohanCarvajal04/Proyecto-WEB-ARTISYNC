...
class PortfolioItemControllerTest {
    ...
    @Mock
    private IPortfolioItemService itemServicio;

    @InjectMocks
    private PortfolioItemController portafolioItemControlador;
    ...
    void subirItem_DebeRetornarCreated() {
        CreatePortfolioItemRequest peticion = new CreatePortfolioItemRequest("Titulo", "Desc");

...
@ContextConfiguration(classes = ContractIntegrityControllerTest.ContextoDePrueba.class)
class ContractIntegrityControllerTest {
    ...
    static class ContextoDePrueba {
        ...
        @Bean
        ContractIntegrityController contratoIntegridadControlador(IContractService servicio) {
            return new ContractIntegrityController(servicio);
        }
    }

    @Autowired
    private ContractIntegrityController controlador;

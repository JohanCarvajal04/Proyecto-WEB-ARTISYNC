...
-- CREATE SEQUENCE seq_codigo_pedido y CREATE INDEX (codigo_pedido, historial
-- por fecha, servicios por perfil y por estado_publicacion). Eso es DDL
-- dentro de una migración REPETIBLE, que Flyway reaplica cada vez que cambia
-- su checksum. Aquí ese DDL vive donde le corresponde: V1__esquema.sql, con
-- las tablas. (El nombre "V8__" de ese archivo tampoco era una versión de
-- Flyway y se confundía con la V8 real, sesiones_usuario_jti.)
--
...
-- ---------------------------------------------------------------------------
-- Origen: db/procs/sp_purgar_notificaciones.sql
-- ---------------------------------------------------------------------------
-- =============================================================================

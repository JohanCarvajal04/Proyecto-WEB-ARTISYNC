...
import uteq.edu.ec.artisync.service.communication.ViolationService;
...
public class ChatServiceImpl implements ChatService {
    ...
    public ChatMessageResponse sendMessage(Long idPedido, Long idRemitente, String cuerpoMensaje) {
        ...
        ChatMessageResponse response = mapToResponse(mensaje, remitente);
    ...
    public Page<ChatMessageResponse> getMessages(Long idPedido, Long idUsuario, Pageable pageable) {
        ...
        List<ChatMessageResponse> page = start > dtos.size() ? List.of() : dtos.subList(start, end);
    ...
    // -------------------------------------------------------------------------
    private ChatMessageResponse mapToResponse(Message m, User remitente) {

package uteq.edu.ec.artisync.entity.order;
 ...
 * 
 * Ciclo de vida: Ciclo volatil y transaccional: se envia, se contrarresta o se acepta, tras lo cual se materializa en un Contract.
 * 
 * Relaciones principales: Anidada temporalmente a un Order en etapa temprana.
 */
@Entity
...
@AllArgsConstructor
@Builder
public class OrderTermsProposal {

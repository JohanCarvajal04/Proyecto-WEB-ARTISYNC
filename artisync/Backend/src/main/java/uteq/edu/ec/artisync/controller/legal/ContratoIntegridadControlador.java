 ...
 * gobierna ese permiso (ver PagoGarantiaAuditoriaControlador) — no se crea
...
public class ContratoIntegridadControlador {
    ...
    public ResponseEntity<RespuestaVerificacionIntegridad> verificarIntegridad(@PathVariable Long idContrato) {

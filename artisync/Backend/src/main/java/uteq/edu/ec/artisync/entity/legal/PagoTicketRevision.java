 ...
 * contrato (REQ-F-022b/c). Entidad propia, no una fila más de PagoGarantia:
 * PagoGarantia.contrato es @OneToOne con FK UNIQUE (un solo pago de garantía
...
@AllArgsConstructor
@Builder
public class PagoTicketRevision {

...
public class PayPalReconciliationScheduler {

    private final EscrowPaymentRepository pagoGarantiaRepository;
    private final PayPalReconciliationExecutorService reconciliacionPayPalEjecutorServicio;
     ...
     * reconcilia en su propia transacción (PayPalReconciliationExecutorService,
    ...
    public void reconciliarPagosPendientes() {
        ...
        log.info("[PayPalReconciliationScheduler] Reconciliando {} pago(s) pendiente(s) de más de {} min",

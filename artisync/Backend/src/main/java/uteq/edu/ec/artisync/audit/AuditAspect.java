...
public class AuditAspect {
    ...
    public Object auditar(ProceedingJoinPoint pjp, Auditable auditable) throws Throwable {
        ...
        AuditResult resultadoEvento = AuditResult.FALLIDO;

        try {
            resultado = pjp.proceed();
            resultadoEvento = AuditResult.EXITO;
            return resultado;
        } catch (AccessDeniedException e) {
            error = e;
            resultadoEvento = AuditResult.DENEGADO;
            throw e;
        } catch (Throwable t) {
            error = t;
            resultadoEvento = AuditResult.FALLIDO;
            throw t;
        } finally {
            try {

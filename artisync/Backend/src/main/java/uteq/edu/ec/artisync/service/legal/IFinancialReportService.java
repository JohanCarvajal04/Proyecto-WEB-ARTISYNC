...
public interface IFinancialReportService {
     ...
     */
    CommissionReportResponse getCommissionReport(FinancialReportFilter filtro);
     ...
     */
    GeneratedDocument export(FinancialReportFilter filtro, ReportFormat formato, String correoSolicitante);
     ...
     * @return el documento generado con el detalle filtrado
     */
    GeneratedDocument export(FinancialReportFilter filtro, ReportFormat formato, Integer page, Integer size, String correoSolicitante);
}

...
public interface ITicketRevisionServicio {
     ...
     * @throws uteq.edu.ec.artisync.exception.ExcepcionRecursoNoEncontrado si el pedido o el motivo indicado no existen
     * @throws uteq.edu.ec.artisync.exception.ExcepcionReglaNegocio si el solicitante no es el cliente del pedido
     */
     ...
     * @throws uteq.edu.ec.artisync.exception.ExcepcionRecursoNoEncontrado si el ticket no existe

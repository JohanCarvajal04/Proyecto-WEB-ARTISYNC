...
import uteq.edu.ec.artisync.dto.response.order.StageConfigResponse;
...
public class WorkflowServiceImpl implements IWorkflowService {
    ...
    public WorkflowResponse createWorkflow(Long idUsuario, CreateWorkflowRequest peticion) {
        ...
        uteq.edu.ec.artisync.entity.security.User creador = usuarioRepository.findById(idUsuario)

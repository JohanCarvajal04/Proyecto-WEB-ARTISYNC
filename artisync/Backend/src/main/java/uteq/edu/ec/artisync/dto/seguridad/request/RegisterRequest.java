...
public class RegisterRequest {
    ...
    @Pattern(regexp = "^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z]).{8,}$", message = "La contraseÃ±a debe contener al menos un nÃºmero, una letra minÃºscula y una letra mayÃºscula")
    private String contrasena;

    @NotNull(message = "La fecha de nacimiento es obligatoria (RNF-12)")
    private LocalDate fechaNacimiento;

    private String rol; // Ejemplo: "CLIENTE" o "CREADOR". Si es nulo, por defecto serÃ¡ "CLIENTE"

    @NotNull(message = "Debes aceptar los tÃ©rminos y condiciones")
    @AssertTrue(message = "Debes aceptar los tÃ©rminos y condiciones")

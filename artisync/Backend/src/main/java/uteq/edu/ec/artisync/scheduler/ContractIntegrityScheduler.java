 ...
 * discrepancia. A las 4:30 AM, después de VerificationScheduler (3:00),
 * SecurityPurgeScheduler (3:30) y NotificationPurgeScheduler (4:00) --
...
public class ContractIntegrityScheduler {
    ...
    public void verificarIntegridadDeTodos() {
        ...
        log.info("[ContractIntegrityScheduler] Verificando la integridad de {} contrato(s) firmado(s)",

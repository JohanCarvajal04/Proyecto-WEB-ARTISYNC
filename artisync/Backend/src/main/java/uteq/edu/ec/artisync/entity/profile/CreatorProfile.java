package uteq.edu.ec.artisync.entity.profile;
 ...
 * 
 * Relaciones principales: Extension 1:1 de la identidad del User. Actua como puerta de entrada a sus Servicios y Portfolio.
 */
@Entity

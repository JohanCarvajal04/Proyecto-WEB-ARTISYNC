 ...
 * ADMIN ({@link PlantillaContratoAdminControlador}). Cada plantilla creada
...
public class PlantillaAcuerdoCreadorControlador {

    private final IPlantillaAcuerdoCreadorServicio plantillaAcuerdoCreadorServicio;
     ...
     */
    @PostMapping
    public ResponseEntity<RespuestaPlantillaContrato> crear(
            @Valid @RequestBody PeticionCrearPlantillaAcuerdoPropia peticion,
    ...
    public ResponseEntity<RespuestaPlantillaContrato> editar(
            ...
            @Valid @RequestBody PeticionActualizarPlantillaAcuerdoPropia peticion,
            @AuthenticationPrincipal CustomUserDetails userDetails) {
     ...
     */
    @GetMapping
    public ResponseEntity<List<RespuestaPlantillaContrato>> listarPropias(@AuthenticationPrincipal CustomUserDetails userDetails) {

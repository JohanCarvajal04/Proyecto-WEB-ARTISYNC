...
public class SecurityPurgeScheduler {
    ...
    public void purgarDatosSeguridad() {
        ...
        try {
            ...
            log.info("[SecurityPurgeScheduler] Purga completada");
        } catch (Exception e) {
            ...
            log.error("[SecurityPurgeScheduler] Error durante la purga de datos de seguridad: {}", e.getMessage(), e);
        }
    }
}

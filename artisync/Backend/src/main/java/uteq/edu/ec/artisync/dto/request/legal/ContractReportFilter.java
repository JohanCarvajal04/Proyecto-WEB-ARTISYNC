package uteq.edu.ec.artisync.dto.request.legal;

import lombok.Data;
import lombok.EqualsAndHashCode;
import uteq.edu.ec.artisync.dto.request.comun.FiltroRangoFechas;

/** Filtros del reporte de contratos, ligados con @ModelAttribute (mismo estilo que FinancialReportFilter). */
@Data
@EqualsAndHashCode(callSuper = true)
public class ContractReportFilter extends FiltroRangoFechas {

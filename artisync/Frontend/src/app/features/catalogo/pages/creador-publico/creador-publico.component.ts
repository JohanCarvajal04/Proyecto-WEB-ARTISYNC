...
export class CreadorPublicoComponent implements OnInit {
   ...
   * mostraban la misma profesión. El backend aún no rellena ese campo
   * (RespuestaPerfil.java no lo tiene), así que por ahora esto queda vacío
   * hasta que se agregue esa columna — la plantilla ya lo trata como opcional.
   */

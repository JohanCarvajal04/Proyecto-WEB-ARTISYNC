...
| P11   | 28 DOI verificados contra doi.org/Crossref/DataCite; 1 corrección (`RALPH2021`)                                                              | `docs/informe-final/referencias.bib`, `scripts/verificar-doi.py`, `docs/mediciones/verificacion-doi.txt`                                    | Bryan Figueroa, Johan Carvajal y Jhon Kevin Ríos |

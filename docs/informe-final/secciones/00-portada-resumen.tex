...
\vspace{0.3cm}
\footnotesize{La nómina oficial del PFC de Aplicaciones Web (Quinto Nivel) registra a
Carvajal Loor, Figueroa Morales y Rios Cuyabazo. Bone Arroyo colabora como cuarta
integrante porque este mismo repositorio es también el caso de estudio de la materia
paralela de Administración de Bases de Datos, con su aporte concentrado en los
procedimientos almacenados (\texttt{db/procs/}); se la reconoce aquí como autora del
software por su contribución de código real y verificable en el historial de Git (ver
\texttt{CONTRIBUTORS.md} y \texttt{README.md}, sección ``Equipo y contribuciones'').}
\end{minipage}\\[1cm]

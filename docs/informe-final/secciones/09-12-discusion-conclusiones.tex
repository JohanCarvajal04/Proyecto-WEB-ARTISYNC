...
código --- líneas 92.88\,\% y ramas 81.93\,\% $\geq$70\,\%, sin excepción
en ninguno de los 48 paquetes con código ejecutable, tanto en el
...
26-08-2026; existe además una nuance de conformidad literal sobre el
...
Capítulo~\ref{cap:implementacion}~\S7.4). Dos revisiones técnicas
independientes (2026-09-05 y 2026-09-14, esta última con reproducción
contra Postgres real e inspección del bytecode de Hibernate~7.4.1)
confirmaron que esta nuance es una restricción estructural de la
combinación exacta Hibernate~7.4.1 + Spring Data JPA + PostgreSQL --- no
un pendiente por falta de esfuerzo --- por lo que se documenta como
excepción arquitectónica aceptada (ADR-006), no como trabajo abierto.
...
\begin{enumerate}
  ...
  \item \textbf{Activar \texttt{jacoco:check} en \texttt{pom.xml}} para
    ...
    cada uno de los 48 paquetes con código ejecutable, ya se supera
    (92.88\,\%/81.93\,\% global; ver \S\ref{cap:evaluacion-resultados}),

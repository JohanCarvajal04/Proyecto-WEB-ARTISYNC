...
ADR-002 & Esquema de autenticación y control de acceso & JWT (HS256)
  ...
  factor 12; \gls{rbac} vía Spring Security. Revisado en agosto 2026 tras
...
ADR-006 & Estrategia híbrida de acceso a datos & CRUD elementales vía
  ...
  Capítulo~\ref{cap:implementacion}); fases posteriores de concurrencia,
  rendimiento, mantenimiento y el módulo de seguidores llevaron el total a
  26 rutinas activas en \texttt{db/procs/} (ver

...
\begin{tikzpicture}[node distance=1.5cm, every node/.style={rectangle, draw, align=center, text width=6cm, minimum height=1cm}]
  ...
  \node (exc3) [right of=incl, xshift=5cm] {Excluded (does not meet IC1/IC2)\\ (n = 13)};
  ...
  \draw[->] (elig) -| (exc3);
\end{tikzpicture}
\caption{PRISMA 2020 flow diagram of the selection process.}
\label{fig:prisma}
\end{figure}
...
Hagiu y Wright~\cite{HAGIU2015} & 2015 & Plataformas multilaterales (\emph{multi-sided}) & No & No & N/A & N/A \\
Gussek et al.~\cite{GUSSEK2023} & 2023 & Tensiones del trabajo freelance en plataformas digitales & No & No & N/A & N/A \\
...
\vspace{4pt}
\footnotesize
\textbf{DOI de los 8 estudios incluidos:}
Laksono et al.~\cite{LAKSONO2024}: \href{https://doi.org/10.32664/smatika.v14i01.1227}{10.32664/smatika.v14i01.1227} \textbullet{}
Waleed et al.~\cite{TSMART2021}: \href{https://doi.org/10.3390/jtaer16060132}{10.3390/jtaer16060132} \textbullet{}
Gu y Zhu~\cite{GU2021}: \href{https://doi.org/10.1287/mnsc.2020.3583}{10.1287/mnsc.2020.3583} \textbullet{}
Bandari~\cite{BANDARI2026}: \href{https://doi.org/10.22214/ijraset.2026.79868}{10.22214/ijraset.2026.79868} \textbullet{}
Hagiu y Wright~\cite{HAGIU2015}: \href{https://doi.org/10.1016/j.ijindorg.2015.03.003}{10.1016/j.ijindorg.2015.03.003} \textbullet{}
Gussek et al.~\cite{GUSSEK2023}: \href{https://doi.org/10.1007/s12525-023-00675-y}{10.1007/s12525-023-00675-y} \textbullet{}
Wang et al.~\cite{WANG2021}: \href{https://doi.org/10.1007/s10664-020-09910-y}{10.1007/s10664-020-09910-y} \textbullet{}
Asgaonkar~\cite{ASGAONKAR2019}: \href{https://doi.org/10.1109/BLOC.2019.8751482}{10.1109/BLOC.2019.8751482}
\end{table}

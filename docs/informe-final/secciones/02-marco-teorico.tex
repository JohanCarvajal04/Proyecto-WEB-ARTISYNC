...
incluyendo la estructura recomendada de un \gls{srs} y el patrón sintáctico de enunciado de requisito
...
en el servidor, cacheable, sistema en capas) que la \gls{api} de Artisync sigue
...
partes, firmado digitalmente para garantizar integridad. Artisync usa \gls{jwt}

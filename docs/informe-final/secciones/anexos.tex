...
repositorio el 7 de septiembre de 2026.
...
Auto-detectadas (rev. téc.)  & 13 & 13 & 0 & 0 & 100,0\,\% \\
\midrule
\textbf{Total}               & \textbf{29} & \textbf{28} & \textbf{0} &
\textbf{1} & \textbf{96,6\,\%} \\
\bottomrule
\end{tabular}
\end{table}
...
Dos observaciones siguen sin resolución completa, y ninguna se presenta
como cerrada sin serlo. \textbf{OBS-AUTO-02} (procedimientos almacenados),
...
\begin{itemize}
  \item \textbf{OBS-14} (access-token en cookie \texttt{HttpOnly}, Tercera
    ...
    autenticación, respaldado por 1230 pruebas, a muy poca distancia del cierre,

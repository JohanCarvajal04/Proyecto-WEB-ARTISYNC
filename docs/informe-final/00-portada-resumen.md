...
**Etiqueta del artefacto:** `v1.0.0` — commit `[PENDIENTE — hash corto del commit de cierre, tras crear el tag]`
**DOI del software (Zenodo):** `10.5281/zenodo.21730559` (correspondiente a `v0.9.0-rc`; actualizar al DOI de la versión `v1.0.0` cuando Zenodo genere la nueva versión del registro)

...
**Etiqueta del artefacto:** `v1.0.0` (ver `docs/informe-final/secciones/13-declaraciones.tex` §1 y `docs/observaciones/OBSERVACIONES.md`, OBS-AUTO-12)
...
**DOI del dataset de mediciones (Zenodo):** `10.5281/zenodo.22236251` (depósito separado del software, licencia CC BY 4.0, conforme al Bloque D.3 de la guía)

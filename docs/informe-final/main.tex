...
\pagenumbering{roman}
\input{secciones/00-portada-resumen}
...
\input{secciones/02-marco-teorico}
\input{secciones/03-trabajos-relacionados}
\input{secciones/04-ingenieria-requisitos}
\input{secciones/05-materiales-metodos}
\input{secciones/06-diseno-arquitectura}
\input{secciones/07-implementacion}
\input{secciones/08-evaluacion-resultados}
\input{secciones/09-12-discusion-conclusiones}
\input{secciones/13-declaraciones}

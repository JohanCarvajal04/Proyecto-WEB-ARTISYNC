...
- `jacoco_*_pct`: la medición vigente (**82.93 % líneas / 71.50 % ramas**, global) se generó el **2026-09-11** (ronda 2 — cierre de la regresión de cobertura en Controladores detectada en la ronda 1 del mismo día), con `./mvnw.cmd -B clean test` (1230 pruebas, 129 clases de test, 0 fallos), commit `e84ab50` + pruebas nuevas de `a6746df`. Las tres capas (servicios, controladores, dominio) superan el 70 % en líneas y ramas — ver el desglose por capa en `jacoco/REPORTE-JACOCO.md`. Reemplaza las mediciones anteriores: 2026-09-11 ronda 1 (81.69 % / 70.44 %, con Controladores bajo el 70 % de ramas), 2026-09-05 ronda 2 (86.75 % / 75.03 %), 2026-09-05 ronda 1 (82.88 % / 70.10 %), 2026-09-04 (80.29 % / 66.44 %), 2026-08-16 (72.0 % / 62.5 %) y 2026-07-30 (23.0 % / 13.8 %), todas conservadas como histórico en `jacoco/REPORTE-JACOCO.md`. No existe una comparación numérica directa frente a la Entrega 1B debido a la refactorización arquitectónica; las razones de ese alcance están especificadas en el mismo reporte.

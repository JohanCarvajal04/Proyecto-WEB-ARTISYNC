...
- `jacoco_*_pct`: la medición vigente (**86.75 % líneas / 75.03 % ramas**) se generó el **2026-09-05** (ronda 2), con `./mvnw.cmd -B clean test` (1039 pruebas, 0 fallos). Reemplaza las mediciones anteriores: 2026-09-05 ronda 1 (82.88 % / 70.10 %), 2026-09-04 (80.29 % / 66.44 %), 2026-08-16 (72.0 % / 62.5 %) y 2026-07-30 (23.0 % / 13.8 %), todas conservadas como histórico en `jacoco/REPORTE-JACOCO.md`. No existe una comparación numérica directa frente a la Entrega 1B debido a la refactorización arquitectónica; las razones de ese alcance están especificadas en el mismo reporte.

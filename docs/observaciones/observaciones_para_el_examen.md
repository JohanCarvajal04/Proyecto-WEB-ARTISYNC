...
| OBS-TR-02 | 28 de 543 métodos públicos con Javadoc; 8 `@param`, 0 `@return`, 1 `@throws`      | ⚠️ parcial (verificado 2026-09-07: **controladores completos (44/44)** pero **interfaces de servicio solo 12 de 38 documentadas**. Conteo total: 644 `@param`, 297 `@return`, 241 `@throws` — mejora enorme respecto al estado inicial, pero la guía §3.10 exige _«servicios y controladores»_. Las 26 interfaces sin documentar incluyen: `legal/` (7), `perfil/` (5), `comunicación/` (4), `seguridad/` (3), `catalogo/` (1), `auditoría/` (1), `pedido/` (1), `social/` (1). Se excluyen `shared/` e `impl/` del conteo.)                                                                    |
...
**Resumen (actualizado 2026-09-07, auditoría exhaustiva contra repositorio):** de 49 observaciones, **41 verificadas como implementadas** (OBS-P0-02 sube a ✅ — cifras ahora consistentes en los 3 documentos, hoy en 28/29 = 96,6 %), **2 parciales** (PISO-04/OBS-D0R-02: falta la firma real del SRS, programada para revisión presencial el día del examen — ya no es un bloqueo sin plan, ver PLAN-EXAMEN-FINAL.md T-06; OBS-TR-02: Javadoc de controladores completo pero solo 12/38 interfaces de servicio documentadas, 26 pendientes), y **4 pendientes sin avance** (1 accionable: OBS-P0-01, hoy en 96,6 % — solo falta OBS-14; 3 irresolubles por diseño/tiempo: OBS-TR-05, OBS-TR-06, OBS-TR-08). **OBS-P0-03 sale de "pendientes sin avance"**: se resolvió documentalmente el 2026-09-07 (nota causal en `CHANGELOG.md`, sin reasignar el tag). **Nota:** OBS-TR-01 (tokens español, ~100% de tipos) sigue pendiente pero no es accionable a esta altura sin riesgo de regresión masiva. DATA-PROVENANCE.md:30 ya está actualizado con la cifra JaCoCo de septiembre. Identidades Git: **corregido 2026-09-07** — con `.mailmap` (`Johan Stalin Carvajal Loor <jcarvajall@uteq.edu.ec>` mapeado sobre sus dos correos previos) y el nuevo hábito de comitear con correo institucional, Carvajal queda unificado en 1 identidad (198 commits). El recuento real de `git shortlog -sne --all` sigue en **5 identidades para 4 personas**: Figueroa (1, ya institucional), Carvajal (1, ya unificado — OBS-TR-08 resuelto para él), Ríos (2, `Jhon-Kevin-Rios-Cuyabazo`/hotmail y `Jk-RiosC`/GitHub noreply, **ninguna institucional, sin `.mailmap`**), Bone (1, ya documentada). OBS-TR-08 queda **parcial**: 3 de 4 personas resueltas, falta Ríos.

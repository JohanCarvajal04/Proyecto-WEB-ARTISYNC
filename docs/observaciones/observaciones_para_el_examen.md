...
| OBS-TR-02 | 28 de 543 métodos públicos con Javadoc; 8 `@param`, 0 `@return`, 1 `@throws` | ✅ resuelta (2026-09-07: **capas de controladores e interfaces de servicio completas**. Con los recientes commits de documentación, el conteo total en `src/main/java` sube a **644 `@param`**, **297 `@return`** y **241 `@throws`**. Se ha cubierto el alcance mínimo acordado (guía §3.10) de documentar controladores y las interfaces de servicio, resolviendo la brecha documentada previamente.) |

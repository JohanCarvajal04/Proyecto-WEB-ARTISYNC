...
| ID        | Observación                                                                       | Estado                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| --------- | --------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| OBS-TR-01 | 80,7 % de tipos y 66,2 % de métodos con token español (línea base 2 de septiembre) | ⚠️ PARCIAL (2026-09-12: tipos ya en 5,5 % tras el rename i18n de dominios; métodos bajó de 58,9 % a **19,2 %** tras renombrar los seis dominios de mayor volumen y mejor cobertura de pruebas — social, comunicación, pedido, catálogo, legal, perfil — con `mvn test` en verde en cada paso. Cifra reproducible con `python scripts/medir-metodos-es.py`. Quedan en español, por orden de peso: `service/shared` (40,9 %, adaptadores de infraestructura), `service/seguridad` (36,8 %) y `service/respaldo` (63,0 %) — ninguno tocado en esta pasada por tener cobertura de ramas más baja o quedar fuera del alcance de "dominios de negocio". El peor de los dos factores (métodos, 19,2 %) ya está muy por debajo del 30 % que exige la rúbrica para salir de "Apenas") |

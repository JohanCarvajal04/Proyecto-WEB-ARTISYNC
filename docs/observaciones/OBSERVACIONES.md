...
| Auto-detectadas (revisión técnica) | — | 3 | 2 | 0 | 1 |
| **Total** | | **15** | **9 (60 %)** | **1 (7 %)** | **5 (33 %)** |
...
| OBS-09 | Entrega 1B | C5 — Pruebas JUnit 5 + Postman (Insuficiente, 3 %) | "Solo el test de carga de contexto autogenerado; las 9 pruebas del informe figuran como [PASS/FAIL] sin ejecutar." | **Parcialmente resuelta.** Hay **18 clases de test y 89 pruebas ejecutándose en verde** (`mvnw test`, 0 fallos, 0 errores), cubriendo seguridad, comunicación y social. **Sigue pendiente:** la colección Postman de 20+ peticiones que exige la Tercera Entrega, y la cobertura JaCoCo está en 23 % frente al 60 % exigido (los módulos pedido, legal, catálogo y perfil no tienen pruebas). | `6042b6c`, `a7231ad`, `825c935` |
...
- Observaciones registradas (docente + auto-detectadas): **15**
- **Resueltas por completo: 9 (60 %)** — OBS-01, 03, 06, 07, 08, 10, 12, AUTO-01, AUTO-03
- **Parcialmente resueltas: 1 (7 %)** — OBS-09 (89 pruebas en verde; faltan Postman y cobertura ≥ 60 %)
- **Pendientes: 5 (33 %)** — OBS-02, 04, 05 (coherencia documental, bajo esfuerzo), OBS-11 (informe PDF), OBS-AUTO-02 (procedimientos almacenados)
